...
global tamanho_do_pacote, taxa_canal_teorica, taxa_canal_calculada, bitrate, medida_atual, perda_geral, st_cmd_led_amarelo
...
def uplink():
   ...
   if(len(Pacote_UL)==tamanho_do_pacote): #52
      ...
      # ----------------------------------------------------------------------
      print("[Nível 3 - Borda] - Física - Pacote de Uplink Recebido")
      # ----------------------------------------------------------------------
      print(*Pacote_UL)
      print("================================================")
      ...
      if(Pacote_UL[8]== 0 and Pacote_UL[10] ==1):
         print("##### OK - Pacote recebido (Uplink) é para esta Borda")
...
while True:
   ...
   if (condicao_start == 1):
      ...
      if (medida_atual == 0): # and (start_teste_site_suvey == 1)):
         ...
         print ('Time stamp;Contador;RSSI_DL;RSSI_UL;Perdas;PSR;Max_DL;Min_DL;Max_UL;Min_UL;valor_atual_spreadingfactor;valor_atual_bandwidth;valor_atual_codingrate;valor_atual_potencia_radio;taxa_canal_teorica;taxa_canal_calculada;snr_DL;snr_UL', file=f)
      ...
      if (medida_atual < numero_de_medidas):
         ...
         print("### Tempo Entre Medidas: ",tempo_entre_medidas, " [s]")
