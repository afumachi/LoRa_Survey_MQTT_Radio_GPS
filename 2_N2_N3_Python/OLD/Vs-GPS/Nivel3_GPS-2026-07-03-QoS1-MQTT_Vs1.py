...
# 
# PacoteDL[Byte_7] => comanda_mac_radio => Pacote Downlink recebe comandos mac no Byte 7 , Pacote de uplink recebe também no Byte 7 os feedbacks da rede LoRa
# 
# comanda_mac_radio = 0
#         Sem reação dos Devices LoRa (Gateway ou Nó Sensor)
#         Nivel 2_3 ou Gateway não esperam nenhum feedback do Nó Sensor
#
# comanda_mac_radio = 1
#         Caso identificado o padrão SF 7, BW 125 kHz, CR 5 ou PW_TX após o comando do botão de Iniciar Medidas do Nível 6 for pressionado
#         comanda_mac_radio = 1 , comando aos Devices LoRa para modificação de Rádio para o realizar o teste de medidas com nova configuração de rádio
#         Gateway LoRa espera receber no Pacote Uplink Byte 7 = 2 => Nó Sensor confirma = 2, que irá modificar o rádio para o próximo pacote em configuração de rádio nova
#         Nivel 2_3 em python espera receber no Pacote Uplink Byte 7 = 3 , onde o Gateway + Nó Sensor (confirmação de ambos devices) que modificaram as configurações de rádio
#         Após recebido Pacote_UL[7] == 3 , efetuar um teste de enlace da rede com comanda_mac_radio = 3
#         Não deve incrementar o número de medidas do teste
#
# comanda_mac_radio = 2
#         A Ser Definido (TBD)
#
...
#         Este teste de enlace deve ser feito sempre que o botão Iniciar Medidas no Nivel 6 for pressionado e não houver mudanças de rádio, ou após um pedido de mudança de rádio, 
#         iniciar o looping com a quantidade de medidas de teste, após finalizado a quantidade de medidas, ficar em standy-by aguardando novo comando do botão Iniciar Medidas no Nivel 6, Após recebido Pacote_UL[7] == 3 
#         Nó Sensor não contabiliza (sem incremento) do Contador de Uplink
#         Não deve incrementar o número de medidas do teste - sem incremento do Contador de Downlinks
#         deve receber Pacote_DL[7] = 6
#
# comanda_mac_radio = 4
#         Após teste de enlace OK, 
#         Indica a rede LoRa inídio das medidas de teste com incremento do número de pacotes de downlinks  - lss em funcionamento
#         Incrementos do Contador de Uplink no nó sensor
#
# comanda_mac_radio = 5
#         Último Pacote do teste de medidas LSS
#         Nó Sensor é informado do último pacote final do LSS para resetar os contadores
#         ( Pode retornar ao [LBDC] LoRa Best Distance Configuration)
#
# comanda_mac_radio = 10
#         Perda de Enlace com o Nó Sensor, comando o Gateway LoRa para operar no padrão de radio
#         Gateway retorna com valor 10 no byte UL[7] e pode ser reiniciado o pedido de teste de enlace ou mudança de rádio
#         Apenas Gateway retorna ao [LBDC] LoRa Radio Configuration - Default
#
"""
...
print("[PKLoRa MQTT] N2_N3 Conectando ao Broker MQTT via porta 1883")
